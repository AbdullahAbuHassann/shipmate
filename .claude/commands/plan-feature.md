...
**Use specialised agents and parallel analysis:**
...
**2. Pattern Recognition** (Use specialised subagents when beneficial)
...
- Catalogue external libraries relevant to feature
- Understand how libraries are integrated (check imports, configs)
- Find relevant documentation in docs/, ai_docs/, .agents/reference if available
...
- Understand test organisation (unit vs integration)
...
- Identify authentication/authorisation patterns if relevant
...
**Use specialised subagents when beneficial for external research:**
...
- Identify performance optimisation patterns
...
**Filename**: `.agents/plans/issue-{number}.md`
